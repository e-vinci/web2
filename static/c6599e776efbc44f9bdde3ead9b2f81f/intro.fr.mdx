...
- a) [Informations générales](#a)
  ...
  - a.5) [Ce qu'il est attendu de vous les étudiants ?](#a5)
...
## <a id="a5"></a> a.5) Ce qu'il est attendu de vous les étudiants ?
### Introduction
...
Voici un résumé par activités pédagogiques et évaluations :
...
##### Introduction
Voici les actions attendues dans le cadre de chacun des 8 modules du cours et de leur activités pédagogiques.
...
Lors du début de la deuxième séance de cours, nous écoutons chaque question et toute la classe participe, dans la mesure du possible, pour apporter une réponse. N'hésitez pas à participer activement à ces échanges, cela enrichira l'expérience de tous !

Des questions vous serons posées afin de s'assurer de la bonne compréhension des concepts. Si nécessaire, des explications, illustrations et présentations seront offertes quand approprié.
...
##### Introduction 
Voici les actions attendues dans le cadre du projet.

##### Activité pédagogique n°4 - projets

La deuxième partie du cours est constituée d'un projet mettant en œuvre toutes les compétences du cours. Un projet est constitué d'environ 4-5 étudiants pouvant réaliser leur travail à leur rythme sous réserve du respect des jalons imposés. 

Tout au long du développement associé au projet, vous devez compléter un rapport en utilisant le modèle de document associé au projet. Vous doivez vous exprimer par rapport à l'atteinte des objectifs fonctionnels, aux difficultés rencontrées et aux conseils pour appliquer la technologie.

A la fin de votre projet, vous doivez réaliser une présentation vidéo de 5 à 10 minutes ayant notamment pour but de promouvoir votre projet.
