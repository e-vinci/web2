...
- a) [Informations générales](#a)
  ...
  - a.4) [Découpes des compétences en modules](#a4)
...
Et pour vous, chers étudiants de Vinci, par le biais du projet Web 2, vous serez apte :

- **Intégrer au développement d'une SPA des technologies non vues en cours** ; vous aurez l'opportunité de sélectionner et appliquer des librairies JS non pratiquées directement dans les exercices de ce cours ; les développeurs frontend ou backend doivent régulièrement analyser et appliquer la documentation associée à de nouveaux outils ;
- **Documenter et présenter en vidéo le développement d'une SPA** ;
- **Analyser le développement de SPA faites par des pairs** ; il est important de découvrir et pouvoir analyser les projets créés par d'autres développeurs.
