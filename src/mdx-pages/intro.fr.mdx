...
- a) [Informations générales](/intro#a)
  - a.1) [Public ciblé](/intro#a1)
  - a.2) [Licence & auteurs](/intro#a2)
  - a.3) [Compétences à la fin du cours](/intro#a3)
  - a.4) [Découpes des compétences en modules](/intro#a4)
...
- d) [Architectures classiques d'applications web](/intro#d)
  - d.1) [Introduction](/intro#d1)
  - d.2) [Multi Page Applications](/intro#d2)
  - d.3) [Single Page Applications](/intro#d3)
  - d.4) [Autres types d'architectures web](/intro#d4)
- e) [Introduction au langage JS](/intro#e)
  - e.1) [Les instructions](/intro#e1)
  - e.2) [Les commentaires](/intro#e2)
  - e.3) [Les variables et constantes](/intro#e3)
  - e.4) [Les opérateurs](/intro#e4)
  - e.5) [Les instructions](/intro#e5)
  - e.6) [Les fonctions](/intro#e6)
  - e.7) [Les boucles](/intro#e7)
  - e.8) [Les tableaux](/intro#e8)
  - e.9) [Les template literals](/intro#e9)
  - e.10) [Les objets](/intro#e10)
  - e.11) [Les exceptions](/intro#e11)
...
sur des ressources ;
- **Créer une Single Page Application (SPA) intégrant une IHM et un web service** ; 
...
## <a id="a4"></a> a.4) Découpes des compétences en modules
