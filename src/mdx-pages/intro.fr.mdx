...
- [**solutions des exercices**](https://github.com/e-vinci/js-exercises.git) ; les solutions des exercices sont données pour tous les exercices qui ne sont pas des bonus (qui ne sont pas tagués par 🍬 ). Nous vous recommandons de toujours offrir un temps raisonnable pour créer, ou tenter de créer, votre propre implémentation d'un exercice, sans regarder la solution. Passé cette étape, n'hésitez pas à consulter la solution 😉. 
