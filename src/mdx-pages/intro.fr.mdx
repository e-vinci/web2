...
- [**boilerplate de base d'une RESTful API**](https://github.com/e-vinci/basic-api-boilerplate) ; il offre le squelette d'une RESTful API créé à l'aide du générateur d'application d'Express et offre en supplément des outils nécessaire aux développeurs web modernes : linter, formater...
