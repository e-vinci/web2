...
- **Créer une Single Page Application (SPA) intégrant une IHM et un web service** ; c'est ce que ferait des frontend développeur en développant une application web selon une architecture web moderne ;
- **Intégrer l'authentification, l'autorisation et les sessions d'utilisateurs au sein de SPA**; c'est ce que ferait tant des développeur frontend que des développeur backend pour sécuriser l'accès à des opérations sur des ressources.
...
Les supports de cours sont découpés en modules afin de traiter de concepts directement en lien 
avec les compétences visées par ce cours.
...
<UnAuthenticatedBlock>
  ...
  <ScrollableImage name="modules-breakdown.png" minWidth="900px" maxWidth="900px" />
...
<AuthenticatedBlock>
  ...
  <ScrollableImage name="planning.PNG" minWidth="2052px" maxWidth="2052px" />

  <figcaption>Lien entre les compétences, les modules du cours et le planning des activités</figcaption>
...
- [**frontend du cours**](https://github.com/e-vinci/web2) ; le frontend a été développé à l'aide de JavaScript. Il met en place une architecture
