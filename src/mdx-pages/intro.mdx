...
Voici l'index de cette page :

- [Supports de cours](/intro#section1)
- [Introduction aux technologies backend Java](/intro#section2)
...
- dans le repo des démos :
- dans le repo des exercices :

# <a id="section2"></a>2. Introduction aux technologies backend Java
...
## 2.2	Jakarta EE
La dernière version officielle de la spécification de Jackarta EE,
...
Chaque serveur **Jackarta EE** possède un **Web Container** + **EJB Container**.
<br/>
...
« standalone » et légers qui peuvent être déployés tant sur la **Java SE platform** que sur la **Jackarta EE platform**.
