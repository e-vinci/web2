...
<PathViewer>
    ...
    <PathViewerItem selected> C) Sécuritsation d'une API </PathViewerItem>
</PathViewer>
...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Exercice 4.3 : Sécurisation de l'API de myMovies </InternalPageMenuItem>
  <InternalPageMenuItem> 🍬 Exercice 4.4 : Auto-refresh de myMovies </InternalPageMenuItem> 
  <InternalPageMenuItem> 🍬 Exercice 4.5 : Gestion de la navigation lors de l'auto-refresh de myMovie </InternalPageMenuItem>
  <InternalPageMenuItem> 🍬 Exercice 4.6 : L'essentiel du cours en action </InternalPageMenuItem> 
</InternalPageMenu>

# c) Sécurisation d'une RESTful API
...
# <InternalPageTitle> Exercice 4.3 : Sécurisation de l'API de myMovies </InternalPageTitle>
...
# <InternalPageTitle> 🍬 Exercice 4.4 : Auto-refresh de myMovies </InternalPageTitle>
...
# <InternalPageTitle> 🍬 Exercice 4.5 : Gestion de la navigation lors de l'auto-refresh de myMovie </InternalPageTitle>
...
# <InternalPageTitle> 🍬 Exercice 4.6 : L'essentiel du cours en action </InternalPageTitle>
