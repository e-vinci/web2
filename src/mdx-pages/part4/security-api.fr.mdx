...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Projet 2.23 : Sécurisation d'API </InternalPageMenuItem>
...
Veuillez lancer le frontend [jwt-fetch](https://github.com/e-vinci/js-demos/tree/main/frontend/frontend-essentials/jwt-fetch) (nous allons le développer tout prochainement, vous pouvez simplement en faire une copie temporaire, l'installer et l'exécuter) et le backend **auths** du site de la pizzeria (**`/web2/tutorials/pizzeria/api/auths`** ou en cas de soucis : [auths](https://github.com/e-vinci/js-demos/tree/main/backend-restful-api/restful-api-essentials/auths)).
...
Pour ce nouveau tutoriel, nous allons continuer le développement de l'API [auths](https://github.com/e-vinci/js-demos/tree/main/backend-restful-api/restful-api-essentials/auths) et la sécuriser.
...
# <InternalPageTitle> Projet 2.23 : Sécurisation d'API </InternalPageTitle>

Vous devez mettre à jour l'API développée pour [Projet 2.22](../auths-api/#project_2_22_authentification_autorisation_doperations) afin de sécuriser l'API pour échapper les caractères dangereux et pour hacher les password.

Le code doit se trouver dans votre repository local et votre web repository (normalement appelé **`web2`**) dans le répertoire nommé **`/project/2.23/api`** sur base d'un copier/coller du code de [Projet 2.22](../auths-api/#project_2_22_authentification_autorisation_doperations).
