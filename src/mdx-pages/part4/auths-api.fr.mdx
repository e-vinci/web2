---
title: "JWT auths API"
description: "Authentification et autorisation d'accès aux opérations d'une RESTful API via JWT"
---
...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> 🍬 Cacher ses secrets </InternalPageMenuItem>
  <InternalPageMenuItem> Mécanisme d'autorisation et vérification du token </InternalPageMenuItem>
  <InternalPageMenuItem> Client REST avec JWT </InternalPageMenuItem>
  <InternalPageMenuItem> Protection des opérations d'écriture d'une API </InternalPageMenuItem>
</InternalPageMenu>
...
# <InternalPageTitle> 🍬 Cacher ses secrets </InternalPageTitle>
...
# <InternalPageTitle> Mécanisme d'autorisation et vérification du token</InternalPageTitle>
...
# <InternalPageTitle> Protection des opérations d'écriture d'une API </InternalPageTitle>
