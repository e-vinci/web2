...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Exercice 2.6 : Génération dynamique de la Homepage de myMovies </InternalPageMenuItem>
  <InternalPageMenuItem> Exercice 2.7 : Génération dynamique d'une table sur base d'un formulaire </InternalPageMenuItem>
...
# <InternalPageTitle> Exercice 2.6 : Génération dynamique de la Homepage de myMovies </InternalPageTitle>
...
# <InternalPageTitle> Exercice 2.7 : Génération dynamique d'une table sur base d'un formulaire </InternalPageTitle>
...
# <InternalPageTitle> 🍬 Exercice 2.8 : design responsive </InternalPageTitle>
