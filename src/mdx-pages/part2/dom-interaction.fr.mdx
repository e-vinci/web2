...
<PathViewer>
    ...
    <PathViewerItem selected> a) DOM & interactions </PathViewerItem>
</PathViewer>
...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Les callbacks </InternalPageMenuItem>
  <InternalPageMenuItem> Création d'une IHM classique : tutoriel </InternalPageMenuItem>
  <InternalPageMenuItem> Exercice 2.2 : compteur d'événements </InternalPageMenuItem>
  ...
  <InternalPageMenuItem> Exercice 2.3 : événements différés dans le temps </InternalPageMenuItem>
  <InternalPageMenuItem> Exercice 2.4 : autres événements </InternalPageMenuItem>
</InternalPageMenu>
...
# <InternalPageTitle> Les callback </InternalPageTitle>
...
# <InternalPageTitle> Création d'une IHM classique : tutoriel </InternalPageTitle>
## Introduction aux tutoriels
...
Une fois un tutoriel réalisé, vous pourrez voir si vous avez bien acquis les compétences en vous attaquant aux exercices qui suivent.
...
# <InternalPageTitle> Exercice 2.2 : compteur d'événements </InternalPageTitle>
...
# <InternalPageTitle> Exercice 2.3 : événements différés dans le temps </InternalPageTitle>
...
# <InternalPageTitle> Exercice 2.4 : autres événements</InternalPageTitle>
