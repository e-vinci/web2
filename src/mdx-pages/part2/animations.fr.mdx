...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Exercice 2.10 : Gérer des événements associés à une animation </InternalPageMenuItem>
...
N'hésitez pas à exécuter cette application et à comprendre le code associé. Ce code va être utilisé à l'exercice un peu plus loin.
...
# <InternalPageTitle> Exercice 2.10 : Gérer des événements associés à une animation </InternalPageTitle>
