...
Afin d'avoir une visibilité de tout le code associé à votre cours de JS, veuillez ouvrir votre répertoire **`web2`** (créé dans le cadre de l'[Exercice 0.1](../part0/git/#exercice_0_1_creer_un_repository_local_et_distant_pour_gerer_vos_exercices_tutoriels)) à l'aide de votre éditeur de code. 
...
A la mi-juin 2023, la version en cours approuvée de ECMAScript est ECMAScript 2022 [[R.24]](/references/#r24).
