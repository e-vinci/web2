...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Exercice 2.12 : Intégration de la RESTful API au sein de l'IHM de myMovies via un proxy </InternalPageMenuItem>
...
# <InternalPageTitle> Exercice 2.12 : Intégration de la RESTful API au sein de l'IHM de myMovies via un proxy </InternalPageTitle>
