...
Au sein de votre repo **`web2`**, veuillez créer le projet nommé **`/web2/tutorials/pizzeria/hmi/async-await`** sur base d'un copié/collé de **`/web2/tutorials/pizzeria/hmi/basic-fetch`** (ou [basic-fetch](https://github.com/e-vinci/js-demos/tree/main/frontend/frontend-essentials/basic-fetch).
