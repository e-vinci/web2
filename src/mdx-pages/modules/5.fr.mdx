...
Ce module vous offre principalement la persistance des ressources via des fichiers JSON et le refactoring de web services afin de faciliter la maintenabilité et la lisibilité du code.

Voici les sujets traités :

- a) [Introduction au JSON et persistance des données](#a)
  - a.1) [Introduction générale](#a1)
...
Si vous ne voyez pas comment utiliser le boilerplate, tout est expliqué dans le **README** associé au repository du boilerplate.  
