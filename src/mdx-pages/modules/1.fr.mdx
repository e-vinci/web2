...
Exécutez cette page web, même si ce n'est pas très esthétique, tous les éléments sont présents.
...
⚡⚡⚡ Veuillez soumettre le lien vers votre web repository (qqch du genre https://github.com/votre_username/web2.git ou https://gitlab.vinci.be/votre_username/web2.git) via ce [formulaire](https://forms.office.com/r/1e5hNWxUJg).  
