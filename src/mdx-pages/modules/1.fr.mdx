...
👍 Pour écrire du code, dans ce cours, nous vous recommandons d'installer, dès maintenant si ça n'est pas déjà fait, **Visual Studio Code** : https://code.visualstudio.com/download [[R.18]](/references/#r18).
...
Voici comment nous souhaitons que vous organisiez la structure de répertoires au sein de votre repo local **web2** :
- **`/exercises`**
  - **`/exercises/module1`**
  - **`/exercises/module2`**
  - **`/exercises/module3`**
