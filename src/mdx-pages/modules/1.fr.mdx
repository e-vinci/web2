...
Veuillez soumettre le lien vers votre web repository (qqch du genre https://github.com/votre_username/web2.git ou https://gitlab.vinci.be/votre_username/web2.git) via le devoir associé sous Moodle.  
