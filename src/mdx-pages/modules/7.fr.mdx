...
Lors de l'exercice précédent (Exercice 6.1), vous aviez une application qui permettait normalement de gérer des films, mais qui n'était pas sécurisée.
...
- N'oubliez pas de tester chaque opération. Par exemple, il faut bien vérifier que l'on ne peut pas créer une pizza sans token via REST Client.
...
Néanmoins, cette API n'est pas encore sécurisée. Les passwords sont disponibles en clair dans un fichier JSON et il est possible de faire des attaques XSS.
