...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Projet 2.21 : déploiement de votre frontend & de votre backend </InternalPageMenuItem>
</InternalPageMenu>
...
# <InternalPageTitle> Projet 2.21 : déploiement de votre frontend & de votre backend </InternalPageTitle>
...
Le code doit se trouver dans votre repository local et votre web repository (normalement appelé **`web2`**) dans le répertoire nommé **`/project/2.21`**.
...
Quand un prototype du frontend est finalisé pour déploiement sur GitHub Pages, veuillez faire un **`commit`** de votre code avec comme message : **`2.21.1 : frontend deployment`**.

Quand un prototype de votre API est finalisé pour déploiement sur Azure, veuillez faire un **`commit`** de votre code avec comme message : **`2.21. : api deployment`**.
