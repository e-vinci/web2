---
title: "Node.js app"
description: "Introduction aux applications backend Nodes.js"
---

# a) Introduction aux applications backend Nodes.js

Voici les sujets traités :
- [Introduction aux applications backend](#1)
- [Node.js c'est quoi ?](#2)
- [Où mettre du code Node.js](#3)
- [Les modules CommonJS](#b4)
- [Introduction aux packages Node.js & npm)](#5)
- [Introduction à Express](#6)
- [Créer une application Express "from scratch"](#7)
- [Créer une application Express via un générateur](#8)
