...
- [Configuration & démarrage d'une RESTful API en Express](#2)
- [Les fonctions middleware en Express](#3)
- [Définition d'une route en Express](#4)
- [Opération de lecture](#5)
- [Chemin et paramètres de route](#6)
- [Chemin et paramètres de requête](#7)
- [Opération de création & parsing du body](#8)
- [Client REST](#9) 
- [Répondre avec un code de statut HTTP](#10) 
- [Opération de suppression & de modification](#11)
- [Exercice 1.1 : Création d'une RESTfull API non protégée pour myMovies](#12)
- [🍬 Exercice 1.2 : Gestion de la pagination, de l'ordre de présentation et du filtrage de films](#13)

## <a id="1"></a> Introduction aux RESTful API & conventions
...
## <a id="2"></a> Configuration & démarrage d'une RESTful API en Express
...
## <a id="3"></a> Les fonctions middleware en Express
...
## <a id="4"></a> Définition d'une route en Express
...
## <a id="6"></a> Chemin et paramètres de route
...
## <a id="7"></a> Chemin et paramètres de requête
...
## <a id="8"></a> Opération de création & parsing du body
...
## <a id="10"></a> Répondre avec un code de statut HTTP
...
## <a id="11"></a> Opérations de suppression et de modification
...
## <a id="12"></a> Exercice 1.1 : Création d'une RESTfull API non protégée pour myMovies
...
## <a id="h"></a> 🍬 Exercice 1.2 : Gestion de la pagination, de l'ordre de présentation et du filtrage de films
