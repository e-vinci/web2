...
# a) Introduction aux RESTful API via Node.js & Express


Voici les sujets traités :
- [Introduction aux RESTful API & conventions](#1)
- [Configuration & démarrage d'une RESTful API via Express](#2)
- [Les fonctions middleware en Express](#3)
- [Définition d'une route en Express](#4)
- [Opération de lecture](#4)
- [Chemin et paramètres de route](#5)
- [Chemin et paramètres de requête](#6)
- [Opération de création & parsing du body](#7)
- [Client REST](#8) 
- [Répondre avec un code de statut HTTP](#9) 
- [Opération de suppression & de modification](#10)
- [Exercice 1.1 : Création d'une RESTfull API non protégée pour myMovies](#12)
- [🍬 Exercice 1.2 : Gestion de la pagination, de l'ordre de présentation et du filtrage de films](#17)

# <a id="d"></a> d) Introduction aux RESTful API & conventions
