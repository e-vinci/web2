---
title: "RESTful API"
description: "Introduction aux RESTful API via Node.js & Express"
---

# b) Introduction aux RESTful API Node.js & Express
...
<InternalPageMenu>
  ...
  <InternalPageMenuItem> Opération de lecture </InternalPageMenuItem>
  <InternalPageMenuItem> Chemin et paramètres de route </InternalPageMenuItem>
  <InternalPageMenuItem> Chemin et paramètres de requête </InternalPageMenuItem>
  ...
  <InternalPageMenuItem> Répondre avec un code de statut HTTP </InternalPageMenuItem>
  <InternalPageMenuItem> Opération de suppression & de modification </InternalPageMenuItem>
  <InternalPageMenuItem> Exercice 1.1 : Création d'une RESTfull API non protégée pour myMovies </InternalPageMenuItem>
  <InternalPageMenuItem> 🍬 Exercice 1.2 : Gestion de la pagination, de l'ordre de présentation et du filtrage de films </InternalPageMenuItem>
</InternalPageMenu>
...
# <InternalPageTitle> Opération de lecture </InternalPageTitle>
...
# <InternalPageTitle> Chemin et paramètres de route </InternalPageTitle>
...
# <InternalPageTitle> Chemin et paramètres de requête </InternalPageTitle>
...
# <InternalPageTitle> Répondre avec un code de statut HTTP </InternalPageTitle>
...
# <InternalPageTitle> Opérations de suppression et de modification </InternalPageTitle>
...
# <InternalPageTitle> Exercice 1.1 : Création d'une RESTfull API non protégée pour myMovies </InternalPageTitle>
...
# <InternalPageTitle> 🍬 Exercice 1.2 : Gestion de la pagination, de l'ordre de présentation et du filtrage de films </InternalPageTitle>
