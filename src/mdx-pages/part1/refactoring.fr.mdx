...
# e) Refactoring à l'aide d'un "fat model"

Voici les sujets traités :
- [Architectures possibles ?](#1)
- [Architecture Express & "fat model"](#2)
- [Exercice 1.4 : Refactor de la RESTfull API pour myMovies](#3)

## <a id="1"></a> Architectures possibles ?
...
## <a id="2"></a> Architecture Express & "fat model"
...
# <a id="3"></a> Exercice 1.4 : Refactoring de la RESTfull API pour myMovies
