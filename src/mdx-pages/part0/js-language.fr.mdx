...
- [Les instructions](#1)
- [Les commentaires](#2)
- [Les variables et constantes](#3)
- [Les opérateurs](#4)
- [Les conditions](#5)
- [Les fonctions](#6)
- [Les boucles](#7)
- [Les tableaux](#8)
- [Les template literals](#9)
- [Les objets](#10)
- [Les exceptions](#11)



## <a id="1"></a> Les instructions
...
## <a id="3"></a> Les variables et constantes
...
Ici nous souhaitons faire un tri d'un `MENU` (qui est un array), nous souhaitons le faire sur une copie de celui-ci.  
💭 Mais pourquoi le faire sur une copie ?  
Et bien, si nous autorisons à trier l'array associé au `MENU`, lorsque nous tenterons d'ajouter un nouvel élément, le dernier élément de l'array ne contiendra plus le dernier id (ou l'id le plus haut) !  
Comme la fonction **sort** modifie l'array sur lequel la méthode est appelée, nous voulons travailler sur une copie de cet array : **`[...MENU]`** crée un nouveau tableau contenant tous les éléments du **MENU**.
...
## <a id="9"></a>9) Les template literals
